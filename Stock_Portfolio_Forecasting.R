...
getSymbols("SPY",src="yahoo",from=as.Date("2010-01-01"),to=as.Date("2021-11-30"),
           periodicity="daily")

SPY_Return <- dailyReturn(SPY$SPY.Adjusted , type='log',)

#top stocks from each industry
getSymbols(c("XOM","SHW","BA","DUK","UNH","JPM","AMZN","KO","AAPL","FB","AMT"),src="yahoo",from=as.Date("2010-01-01"),to=as.Date("2021-11-30"),
           periodicity="daily")
XOM_Return <- dailyReturn(XOM$XOM.Adjusted , type='log',)
SHW_Return <- dailyReturn(SHW$SHW.Adjusted , type='log',)
BA_Return <- dailyReturn(BA$BA.Adjusted , type='log',)
DUK_Return <- dailyReturn(DUK$DUK.Adjusted , type='log',)
UNH_Return <- dailyReturn(UNH$UNH.Adjusted , type='log',)
JPM_Return <- dailyReturn(JPM$JPM.Adjusted , type='log',)
AMZN_Return <- dailyReturn(AMZN$AMZN.Adjusted , type='log',)
KO_Return <- dailyReturn(KO$KO.Adjusted , type='log',)
AAPL_Return <- dailyReturn(AAPL$AAPL.Adjusted , type='log',)
FB_Return <- dailyReturn(FB$FB.Adjusted , type='log',)
AMT_Return <- dailyReturn(AMT$AMT.Adjusted , type='log',)
returns = merge(XOM_Return,SHW_Return,BA_Return,DUK_Return,UNH_Return,JPM_Return,AMZN_Return,KO_Return,AAPL_Return,AMT_Return,all=TRUE)
